...
SOURCE_CATALOG: Dict[str, SourceSpec] = {
    ...
    "hackertarget_subdomain": _spec("hackertarget_subdomain", "subdomains", ["api.hackertarget.com"], notes="HackerTarget passive subdomain feed"),
    ...
    "dnsgrep": _spec("dnsgrep", "subdomains", ["www.dnsgrep.nl"], notes="DNSGrep historical subdomain search"),
    "shrewdeye": _spec("shrewdeye", "subdomains", ["shrewdeye.app"]),
    ...
    "dnsdumpster": _spec("dnsdumpster", "subdomains", ["dnsdumpster.com"]),
    ...
    "sitedossier": _spec("sitedossier", "subdomains", ["www.sitedossier.com"]),
    ...
    "riddler": _spec("riddler", "subdomains", ["riddler.io"], notes="riddler.io passive DNS search"),
    "omnisint": _spec("omnisint", "subdomains", ["sonar.omnisint.io"], notes="Omnisint/ODIN passive subdomain data"),
    "google_ct": _spec("google_ct", "ct", ["transparencyreport.google.com"], notes="Google Certificate Transparency report"),
    "trickest": _spec("trickest", "subdomains", ["dns.trickest.io"], notes="Trickest passive DNS endpoint"),
    ...
    "github_code_emails": _spec("github_code_emails", "emails", ["api.github.com", "github.com"]),
