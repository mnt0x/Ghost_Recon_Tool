...
def _bug_bounty_summary(data: Dict[str, Any]) -> Dict[str, Any]:
    return {
...
def _web_archive_export(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    interesting_paths = _normalize_archive_bucket(
    ...
    if uncategorized_urls:
        interesting_paths.extend(uncategorized_urls)
        interesting_paths = _normalize_archive_bucket(interesting_paths, domain)
        categorized_seen = {str(row.get("url", "")) for row in interesting_paths}
        uncategorized_urls = [row for row in all_urls if str(row.get("url", "")) not in categorized_seen]
...
def build_canonical_report(result: Any) -> Dict[str, Any]:
    ...
    canonical = {
        ...
        "bug_bounty": _bug_bounty_summary(data),
